(function( $ ){
    ...
    $(function() {
        ...
        uploader.on('uploadSuccess', function (file, response) {
            ...
            window.parent.$("#imagetext").val(response.url);
            window.parent.$("#cover_img").attr('src', response.url);
        });
        // 添加“添加文件”的按钮，
        uploader.addButton({
            id: '#filePicker2',
        ...
        function setState( val ) {
            ...
            switch ( state ) {
                ...
                case 'finish':
                    stats = uploader.getStats();
                    if ( stats.successNum ) {
                    	$.alertMessager( '上传成功，即将关闭窗口~', "success" );
                    	$('.progress').hide();
                    	setTimeout(function() {
