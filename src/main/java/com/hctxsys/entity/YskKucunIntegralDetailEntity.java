...
@Entity
@Table(name = "ysk_kucun_integral_detail", schema = "hctx_db", catalog = "")
public class YskKucunIntegralDetailEntity {
    private int id;
    ...
    public boolean equals(Object o) {
        ...
        YskKucunIntegralDetailEntity that = (YskKucunIntegralDetailEntity) o;
        return id == that.id &&
                uid == that.uid &&
                status == that.status &&
