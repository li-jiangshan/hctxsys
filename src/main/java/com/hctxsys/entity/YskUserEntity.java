...
public class YskUserEntity implements Serializable {
    ...
    private YskUserCheckinfoEntity checkinfoEntity;
    private Set<YskGoodCarEntity> userCarList;
    private Set<YskUserAddressEntity> addressList;
    @OneToMany(fetch = FetchType.LAZY)
    @JoinColumn(name = "uid",referencedColumnName = "userid")
    public Set<YskGoodCarEntity> getUserCarList() {
        return userCarList;
    }

    public void setUserCarList(Set<YskGoodCarEntity> userCarList) {
        this.userCarList = userCarList;
    }

    @OneToMany(fetch = FetchType.LAZY)
    @JoinColumn(name = "user_id",referencedColumnName ="userid" )
    public Set<YskUserAddressEntity> getAddressList() {
        return addressList;
    }

    public void setAddressList(Set<YskUserAddressEntity> addressList) {
        this.addressList = addressList;
    }

    @OneToOne
    @JoinColumn(name = "userid",referencedColumnName = "uid")
    public YskUserCheckinfoEntity getCheckinfoEntity() {
        return checkinfoEntity;
    }

    public void setCheckinfoEntity(YskUserCheckinfoEntity checkinfoEntity) {
    ...
    public boolean equals(Object o) {
        ...
        YskUserEntity that = (YskUserEntity) o;
